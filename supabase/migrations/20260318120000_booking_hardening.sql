-- =============================================================================
-- Booking hardening: timeslot params, re-booking after decline/cancel,
-- enhanced booking request details
-- =============================================================================

-- ---------------------------------------------------------------------------
-- 1. Recreate submit_booking_request_v2 with timeslot + detail params
--    and allow re-booking from declined/cancelled conversations
-- ---------------------------------------------------------------------------
...
-- Permissions
revoke all on function public.submit_booking_request_v2(uuid, uuid, date, text, uuid, time, time, text, text, text, text[]) from public;
revoke all on function public.submit_booking_request_v2(uuid, uuid, date, text, uuid, time, time, text, text, text, text[]) from anon;
grant execute on function public.submit_booking_request_v2(uuid, uuid, date, text, uuid, time, time, text, text, text, text[]) to service_role;
