...
Deno.serve(async (request) => {
  ...
  try {
    ...
    const payload = await parseJSON<CancelBookingPayload>(request);
    ...
    // Analytics side-effect: track booking_cancelled
    try {
      ...
      console.warn("Analytics insert failed (cancel-booking):", analyticsError);
    }
